#!/bin/bash
# rodar.sh
# Script para compilar e rodar o projeto GHDL — Lab 8 Validação
...
echo "Simulação concluída! Arquivo de onda gerado: processador_tb.ghw"

# Abrir GTKWave com o arquivo de ondas atualizado
echo "Abrindo a forma de onda..."
